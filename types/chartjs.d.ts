/**
 * Wrapping of esm ChartJS as non module typings
 *
 * @version v3.7.1
 * @author Felix Vogel
 */
...
declare module Chart {
    ...
    export interface DateAdapter {
         ...
         * @param {TimeUnit} unit - the unit as string
         * @return {number}
         */
         ...
         * @param {number} timestamp - the input timestamp
         * @param {TimeUnit|'isoWeek'} unit - the unit as string
...
// export { LayoutItem, LayoutPosition } from './layout';
    ...
    export type ChartMeta<TElement extends Element = Element,
    ...
    export class DatasetController<TType extends ChartType = ChartType,
    ...
    export type ChartComponentLike = ChartComponent | ChartComponent[] | { [key: string]: ChartComponent } | Plugin | Plugin[];
    ...
    export interface BarElement<T extends BarProps = BarProps,
        O extends BarOptions = BarOptions> extends Element<T, O>, VisualElement {
    }
    ...
    export interface TooltipCallbacks<TType extends ChartType,
    ...
    export interface ExtendedPlugin<TType extends ChartType,
        O = AnyObject,
        Model = TooltipModel<TType>> {
        /**
    ...
    export type ChartOptions<TType extends ChartType = ChartType> = DeepPartial<CoreChartOptions<TType> &
    ...
    export type ChartDataset<TType extends ChartType = ChartType,
        TData = DefaultDataPoint<TType>> = DeepPartial<{ [key in ChartType]: { type: key } & ChartTypeRegistry[key]['datasetOptions'] }[TType]> & ChartDatasetProperties<TType, TData>;
